...
# --------------------
# Same as the GetBeta function but with the addition inter-market migration
# (represented by additional terms i and e)
...
# --------------------
# Same as the GetCost function but with the addition inter-market migration
# (represented by additional terms i and e)
...
#-------------------------
# - Used in the analysis of inter-market migration
